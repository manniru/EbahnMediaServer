			...
			if (apply_ass_styling) {
				...
				if (override_ass_style) {
					...
					if (configuration.getMencoderFont() != null && configuration.getMencoderFont().length() > 0) {
						 ...
						 */
						sb.append(" -font ").append(quoteArg(configuration.getMencoderFont())).append(" ");
						sb.append(" -ass-force-style FontName=").append(quoteArg(configuration.getMencoderFont())).append(",");
					} else {
